...
public class TyposTest {
    ...
    public void checkTyposTest() {
        ...
        WebElement firstParagraph = driver.findElement(By.xpath("//div[@class='example']/p[1]"));
        ...
        WebElement secondParagraph = driver.findElement(By.xpath("//div[@class='example']/p[2]"));
